...
// LEDS
int BLUE_LED = 13; // blue led | needs water
int RED_LED = 10; // red led |  too much water
int GREEN_LED = 9;// green led | all good
...
void lightsOff(){
  ...
  digitalWrite(BLUE_LED, LOW);     // turn off LED1

  digitalWrite(RED_LED, LOW);     // turn off LED2
